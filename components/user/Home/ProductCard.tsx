...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  return (
    <div className="rounded-2xl w-80 sm:w-full bg-white  px-5 pb-5 shadow-xl ">
      ...
      <div className="pt-6">
        <div className="mb-4 flex items-center sm:justify-between ">
          <span className="me-2 rounded   sm:pe-2.5 sm:py-2  text-xs font-medium text-slate-400">
            {product.discount}
          </span>

          <div className="flex ml-29 sm:m-0 items-center justify-end gap-1">
        ...
        <a href="#" className=" sm:max-w-full sm:text-lg font-semibold leading-tight text-gray-900 hover:underline  line-clamp-2">
          {product.name}
        </a>
        ...
        <ul className="mt-5 sm:mt-3 flex flex-wrap items-center gap-2 sm:gap-4">
          {product.badges.map((badge, index) => (
        ...
        <div className="mt-4 flex flex-row items-start sm:items-center  md:justify-between gap-3">
          ...
          <Button variant="outline" className='hover:text-white hover:bg-black ml-25 sm:m-0'>Buy Now</Button>
        </div>
      </div>
    </div>
  );
